...
Customer::Customer(string fname, string lname, double balance, double limit, string phone) : name(fname, lname), credit(balance, limit) {
	this->phoneNumber = phone;
}

void Customer::showCustomer() {
	cout << "Customer "; this->name.displayFullName(); cout << this->phoneNumber << endl;
